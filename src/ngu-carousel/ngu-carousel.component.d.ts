import { ElementRef, Renderer2, OnInit, OnDestroy, EventEmitter, AfterContentInit, AfterViewInit, OnChanges, SimpleChanges } from '@angular/core';
...
export declare class NguCarouselComponent implements OnInit, AfterContentInit, AfterViewInit, OnDestroy, OnChanges {
    ...
    listener7: any;
    listener8: any;
    constructor(el: ElementRef, renderer: Renderer2, platformId: Object);
