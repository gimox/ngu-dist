...
import { Component, ElementRef, Renderer2, Input, Output, EventEmitter, ContentChildren, QueryList, ViewChild, ContentChild, ViewChildren, Inject, PLATFORM_ID } from '@angular/core';
